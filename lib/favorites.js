...
export const addFavorite = async (movie) => {
  try {
    ...
    if (isSupabaseConfigured()) {
      ...
      if (existing?.id) return { success: false, error: "Film je již v oblíbených", code: "ALREADY_EXISTS" };
    ...
    if (Platform.OS === "web") {
      ...
      if (existing) return { success: false, error: "Film je již v oblíbených", code: "ALREADY_EXISTS" };
